...
/* ─────────────────────────────────────────
   DOM 요소
>>>>>>> c24b1d2700edf124034febe7c24b5b57d785f0a5
───────────────────────────────────────── */
...
<<<<<<< HEAD
const togglePasswordChangeBtn =
  document.getElementById('toggle-password-change')
...
if (togglePasswordChangeBtn) {
  togglePasswordChangeBtn.addEventListener(
    'click',
    () => {
      const isVisible =
